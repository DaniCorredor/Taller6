...
public class Aplicacion {
	...
	public static void main(String[] args) throws IOException, HamburguesaException, PedidoPrecioException {
		Aplicacion consola = new Aplicacion();
		consola.ejecutarAplicacion();
	}
	
	public void cargarDatos() throws IOException, HamburguesaException{
	...
	public void ejecutarAplicacion() throws IOException, HamburguesaException, PedidoPrecioException
	{
	...
	public void recibirPedido() throws PedidoPrecioException {
		try {
